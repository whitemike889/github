    ...
    return (
      <div className="github-PrPaneItem native-key-bindings">
        <div className="github-PrPaneItem-container">
          ...
          <div className="github-PrPaneItem-row issueish-avatar-and-title">
            <div className="github-PrPaneItem-rowGroup">
            ...
            <div className="github-PrPaneItem-rowGroup refresh-button">
              <Octicon
                icon="repo-sync"
          ...
          <div className="github-PrPaneItem-row issueish-badge-and-link">
            <div className="github-PrPaneItem-rowGroup">
          ...
          <nav className="github-PrPaneItem-nav">
            <div className="github-PrPaneItem-navItem is-selected">
              <Octicon icon="comment-discussion" />
              Conversation
              <span className="badge">18</span>
            </div>
            <div className="github-PrPaneItem-navItem">
          ...
          <div className="github-PrPaneItem-subView">
